...
print(time.time() - start, 'время выполнения программы')
...
# Вывод
# В рамках лабораторной работы мы познакомились и разработали с нейросетью аппроксимирующей функцию cos(x) + x
# на отрезке от -5 до 5, нейросеть училась на тестовой выборке 1000 элементов. Шаг сходимости: 0.001, количество
# внутренних слоёв: 4, количество нейронов в каждом слое: 4, количество поколений: 20 использовался язык
# программирования Python и библиотеки tensorflow, matplotlib.
